    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <div 
            className="bg-white/10 dark:bg-gray-900/30 backdrop-blur-md rounded-xl p-8 mb-8 cursor-pointer transition-colors"
            onClick={nextQuote}
          >
          ...
          <button 
            ...
            className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white px-8 py-4 rounded-full font-medium text-lg inline-flex items-center gap-2 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
          >
