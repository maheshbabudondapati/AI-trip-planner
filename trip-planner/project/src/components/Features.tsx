        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature) => {
            ...
            return (
              <div 
                key={feature.title}
                className="group p-8 bg-gray-50 rounded-xl hover:bg-yellow-600 transition-colors duration-300"
              >
                <Icon className="w-8 h-8 text-yellow-600 group-hover:text-white mb-4" />
