        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              ...
              <a href="mailto:contact@wanderlust.com" className="text-gray-600 hover:text-yellow-600">
            ...
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              ...
              <a href="tel:+15551234567" className="text-gray-600 hover:text-yellow-600">
                +1 (555) 123-4567
              </a>
            </div>
            <div className="text-center p-6 bg-gray-50 rounded-lg">
