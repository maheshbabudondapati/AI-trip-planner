...
const worldGuides: Guide[] = [
  ...
  },
  {
    ...
    description: "Experience the perfect blend of ancient traditions and modern culture in Japan. From bustling Tokyo to serene Kyoto, discover the essence of Japan.",
    duration: "12 days",
    location: "Japan",
    bestTime: "Mar-May",
    budget: "$3,000-4,000",
    ...
    itinerary: [
      {
        day: 1,
        title: "Tokyo Arrival",
        description: "Begin your Japanese journey in the exciting capital",
        activities: [
          "Airport transfer to Tokyo hotel",
    ...
    tips: [
      "Get a Japan Rail Pass before arriving",
...
const usaGuides: Guide[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1542259009477-d625272157b7?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80",
    description: "Experience the diverse landscapes and cultures of Hawaii's main islands. From volcanic landscapes to pristine beaches.",
    duration: "10 days",
    location: "Hawaii, USA",
    bestTime: "Dec-Apr",
    budget: "$3,500-4,500",
    ...
    itinerary: [
      {
        day: 1,
        title: "Oahu Arrival",
        description: "Begin your Hawaiian adventure in Honolulu",
        activities: [
          "Lei greeting at airport",
          "Check-in at Waikiki hotel",
          "Sunset beach dinner",
          "Evening luau show"
        ]
      }
    ...
    tips: [
      ...
      "Pack both beach and hiking gear",
